        ...
        <div class="container detail-layout">
          ...
          <div>
            <div class="card sidebar-card"><div class="card-body space-y-4">
              ...
              <a href="https://wa.me/919876543210?text=${waText}" target="_blank" rel="noopener" class="btn btn-outline btn-full">${VE.ICONS.message} Enquire on WhatsApp</a>
            </div></div>
          </div>
        </div>
      </section>
        ...
        <div class="modal">
          ...
          <form id="package-enquiry-form" class="space-y-4">
            ...
            <div style="display:flex;gap:0.5rem">
              ...
              <a href="https://wa.me/919876543210?text=${waText}" target="_blank" rel="noopener" class="btn btn-outline">${VE.ICONS.message}</a>
            </div>
          </form>
        </div>
      </div>`;
