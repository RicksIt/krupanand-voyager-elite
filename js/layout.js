...
(function () {
  ...
  const NAV = [
    ...
    { href: "travel-plan.html", label: "Plan Trip", page: "travel-plan" },
  ...
  function renderHeader(activePage) {
    ...
    return `<header class="site-header">
      <div class="header-inner">
        <a href="index.html" class="logo">${ICONS.mapPin}<span>${esc(cfg.brand.short)}</span></a>
  ...
  function renderFooter() {
    ...
    const quickLinks = [
      ...
      { href: "packages.html", label: "Travel Packages" },
    ...
    const destLinks = cfg.popularDestinations
      .map((d) => `<li><a href="destination.html?slug=${d.toLowerCase()}">${esc(d)}</a></li>`)
      .join("");
    ...
    return `<footer class="site-footer">
      ...
      <div class="container footer-bottom">
        ...
        <div style="display:flex;gap:1rem"><a href="index.html">Privacy Policy</a><a href="index.html">Terms of Service</a></div>
      </div>
    </footer>`;
  }
